...
public class SoccerController extends BaseController
{
	 ...
	 */
	@RequestMapping("/stat")
	public ModelAndView getStat(String type)
	{
		int index = getStatPageIndex(type);
		ModelAndView view = new ModelAndView("stat" + STAT_PAGE_TYPES[index][0] + ".soccer");
		return view;
	}
	...
	public ModelAndView getBjop(String mid)
	{
		...
		// VarianceItem firstVar = MatchOddsUtil.computeOpFirstVariance(mid,
		// list);
