 ...
 */
public class QuartzTestJob implements BaseJob, WebPageStatusListener
{
	private static Logger logger = Logger.getLogger(QuartzTestJob.class);
	...
	public void execute(JobExecutionContext context) throws JobExecutionException
	{
		...
		Downloader downloader = getOrCreateWebPageDownloader(defaulSetting);
		if (downloader == null)
		{
