...
<link rel="stylesheet" type="text/css" href="../content/css/soccer/footballcalendar.css" />
<link rel="stylesheet" type="text/css" href="../content/css/soccer/common.css" />
<body>
<!-- 页头 -->
...
<!-- 主要内容 -->
<%@include file="./center/footballcalendar.jsp"%>
...
<script type="text/javascript" src="../content/scripts/soccer/calendar_v1.js"></script>
