...
public class App
{
	...
	public static void main(String[] args)
	{
		 ...
		 *
		 * - datumbox.configuration.properties: It defines for the default storage
		 * engine (required) - datumbox.concurrencyconfiguration.properties: It controls
		 * the concurrency levels (required) -
		 * datumbox.inmemoryconfiguration.properties: It contains the configurations for
		 * the InMemory storage engine (required) -
		 * datumbox.mapdbconfiguration.properties: It contains the configurations for
		 * the MapDB storage engine (optional) - logback.xml: It contains the
