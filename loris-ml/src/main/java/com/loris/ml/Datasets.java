...
public class Datasets
{
	...
	public static Dataframe[] carsNumeric(Configuration conf)
	{
		...
		*/
		...
		try (Reader fileReader = new InputStreamReader(
				Datasets.class.getClassLoader().getResourceAsStream("datasets/carsNumeric.csv"), "UTF-8"))
		{
	...
	public static Dataframe[] carsCategorical(Configuration conf)
	{
		...
		*/
		Dataframe trainingData;
		try (Reader fileReader = new InputStreamReader(
				Datasets.class.getClassLoader().getResourceAsStream("datasets/carsCategorical.csv"), "UTF-8"))
		{
			LinkedHashMap<String, TypeInference.DataType> headerDataTypes = new LinkedHashMap<>();
	...
	public static Dataframe[] housingNumerical(Configuration conf)
	{
		...
		Dataframe trainingData;
		try (Reader fileReader = new InputStreamReader(
				Datasets.class.getClassLoader().getResourceAsStream("datasets/housing.csv"), "UTF-8"))
		{
			LinkedHashMap<String, TypeInference.DataType> headerDataTypes = new LinkedHashMap<>();
	...
	public static Dataframe[] winesOrdinal(Configuration conf)
	{
		...
		Dataframe trainingData;
		try (Reader fileReader = new InputStreamReader(
				Datasets.class.getClassLoader().getResourceAsStream("datasets/winesOrdinal.csv"), "UTF-8"))
		{
			LinkedHashMap<String, TypeInference.DataType> headerDataTypes = new LinkedHashMap<>();
	...
	public static Dataframe[] gaussianClusters(Configuration conf)
	{
		...
		{
			trainingData.add(Datasets.<Object>newDataVector(new Object[]
			{ rnd.nextGaussian(), rnd.nextGaussian() }, "c1"));
		}

		for (int i = 0; i < observationsPerCluster; ++i)
		{
			trainingData.add(Datasets.<Object>newDataVector(new Object[]
			{ 100 + rnd.nextGaussian(), 50 + rnd.nextGaussian() }, "c2"));
		}

		for (int i = 0; i < observationsPerCluster; ++i)
		{
			trainingData.add(Datasets.<Object>newDataVector(new Object[]
			{ 50 + rnd.nextGaussian(), 100 + rnd.nextGaussian() }, "c3"));
		}
	...
	public static Dataframe[] multinomialClusters(Configuration conf)
	{
		...
		// cluster 1
		trainingData.add(Datasets.<Object>newDataVector(new Object[]
		{ 10.0, 13.0, 5.0, 6.0, 5.0, 4.0, 0.0, 0.0, 0.0, 0.0 }, "c1"));
		trainingData.add(Datasets.<Object>newDataVector(new Object[]
		{ 11.0, 11.0, 6.0, 7.0, 7.0, 3.0, 0.0, 0.0, 1.0, 0.0 }, "c1"));
		trainingData.add(Datasets.<Object>newDataVector(new Object[]
		{ 12.0, 12.0, 10.0, 16.0, 4.0, 6.0, 0.0, 0.0, 0.0, 2.0 }, "c1"));
		trainingData.add(Datasets.<Object>newDataVector(new Object[]
		{ 10.0, 13.0, 5.0, 6.0, 5.0, 4.0, 0.0, 0.0, 0.0, 0.0 }, "c1"));
		trainingData.add(Datasets.<Object>newDataVector(new Object[]
		{ 11.0, 11.0, 6.0, 7.0, 7.0, 3.0, 0.0, 0.0, 1.0, 0.0 }, "c1"));
		...
		// cluster 2
		trainingData.add(Datasets.<Object>newDataVector(new Object[]
		{ 10.0, 13.0, 0.0, 0.0, 0.0, 0.0, 5.0, 6.0, 5.0, 4.0 }, "c2"));
		trainingData.add(Datasets.<Object>newDataVector(new Object[]
		{ 11.0, 11.0, 0.0, 0.0, 1.0, 0.0, 6.0, 7.0, 7.0, 3.0 }, "c2"));
		trainingData.add(Datasets.<Object>newDataVector(new Object[]
		{ 12.0, 12.0, 0.0, 0.0, 0.0, 2.0, 10.0, 16.0, 4.0, 6.0 }, "c2"));
		trainingData.add(Datasets.<Object>newDataVector(new Object[]
		{ 10.0, 13.0, 0.0, 0.0, 0.0, 0.0, 5.0, 6.0, 5.0, 4.0 }, "c2"));
		trainingData.add(Datasets.<Object>newDataVector(new Object[]
		{ 11.0, 11.0, 0.0, 0.0, 1.0, 0.0, 6.0, 7.0, 7.0, 3.0 }, "c2"));
		...
		// cluster 3
		trainingData.add(Datasets.<Object>newDataVector(new Object[]
		{ 10.0, 13.0, 5.0, 6.0, 5.0, 4.0, 5.0, 6.0, 5.0, 4.0 }, "c3"));
		trainingData.add(Datasets.<Object>newDataVector(new Object[]
		{ 11.0, 11.0, 6.0, 7.0, 7.0, 3.0, 6.0, 7.0, 7.0, 3.0 }, "c3"));
		trainingData.add(Datasets.<Object>newDataVector(new Object[]
		{ 12.0, 12.0, 10.0, 16.0, 4.0, 6.0, 10.0, 16.0, 4.0, 6.0 }, "c3"));
		trainingData.add(Datasets.<Object>newDataVector(new Object[]
		{ 10.0, 13.0, 5.0, 6.0, 5.0, 4.0, 5.0, 6.0, 5.0, 4.0 }, "c3"));
		trainingData.add(Datasets.<Object>newDataVector(new Object[]
		{ 11.0, 11.0, 6.0, 7.0, 7.0, 3.0, 6.0, 7.0, 7.0, 3.0 }, "c3"));
	...
	{
		// Heart Disease - C2: Age, Sex, ChestPain, RestBP, Cholesterol, BloodSugar,
		// ECG, MaxHeartRate, Angina, OldPeak, STSlope, Vessels, Thal
		// http://www.sgi.com/tech/mlc/db/heart.names
		Dataframe trainingData;
		try (Reader fileReader = new InputStreamReader(
				Datasets.class.getClassLoader().getResourceAsStream("datasets/heart.csv"), "UTF-8"))
		{
			LinkedHashMap<String, TypeInference.DataType> headerDataTypes = new LinkedHashMap<>();
			headerDataTypes.put("Age", TypeInference.DataType.NUMERICAL);
	...
	public static Dataframe[] ensembleLearningResponses(Configuration conf)
	{
		...
		Dataframe validationData = new Dataframe(conf);
		validationData.add(Datasets.<String>newDataVector(new String[]
		{ "pos", "pos" }, "pos"));
		validationData.add(Datasets.<String>newDataVector(new String[]
		{ "pos", "neg" }, "pos"));
		validationData.add(Datasets.<String>newDataVector(new String[]
	...
	public static Dataframe[] featureSelectorCategorical(Configuration conf, int n)
	{
		...
		for (int i = 0; i < n; ++i)
		{
			...
			double richScore = xData.getDouble("has_boat") + xData.getDouble("has_luxury_car")
			// + ((xData.get("has_butler").equals("yes"))?1.0:0.0)
					+ xData.getDouble("has_butler") + xData.getDouble("has_pool");
	...
	public static Dataframe[] featureTransformationPCA(Configuration conf)
	{
		...
		originalData.add(Datasets.<Double>newDataVector(new Double[]
		{ 1.0, 2.0, 3.0 }, null));
		originalData.add(Datasets.<Double>newDataVector(new Double[]
		{ 0.0, 5.0, 6.0 }, null));
		originalData.add(Datasets.<Double>newDataVector(new Double[]
		...
		transformedData.add(Datasets.<Double>newDataVector(new Double[]
		{ -3.4438, 0.0799, -1.4607 }, null));
		transformedData.add(Datasets.<Double>newDataVector(new Double[]
		{ -6.0641, 1.0143, -4.8165 }, null));
		transformedData.add(Datasets.<Double>newDataVector(new Double[]
		{ -7.7270, 6.7253, 2.8399 }, null));
		transformedData.add(Datasets.<Double>newDataVector(new Double[]
		{ -14.1401, -6.4677, 1.4920 }, null));
		transformedData.add(Datasets.<Double>newDataVector(new Double[]
		{ -23.8837, 3.7408, -2.3614 }, null));
	...
	public static Dataframe[] regressionNumeric(Configuration conf)
	{
		...
		*/
		Dataframe trainingData;
		try (Reader fileReader = new InputStreamReader(
				Datasets.class.getClassLoader().getResourceAsStream("datasets/regressionNumeric.csv"), "UTF-8"))
		{
			LinkedHashMap<String, TypeInference.DataType> headerDataTypes = new LinkedHashMap<>();
			headerDataTypes.put("c1", TypeInference.DataType.NUMERICAL);
			headerDataTypes.put("c2", TypeInference.DataType.NUMERICAL);
	...
	public static Dataframe[] regressionMixed(Configuration conf)
	{
		...
		*/
		Dataframe trainingData;
		try (Reader fileReader = new InputStreamReader(
				Datasets.class.getClassLoader().getResourceAsStream("datasets/regressionMixed.csv"), "UTF-8"))
		{
			LinkedHashMap<String, TypeInference.DataType> headerDataTypes = new LinkedHashMap<>();
