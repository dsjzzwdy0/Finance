...
import com.loris.stock.analysis.utils.CharacterUtil;
...
public class FinalSeg
{
	...
	private static char[] states = new char[]
	{
			'B', 'M', 'E', 'S'
	};
	...
	private void loadModel()
	{
		...
		prevStatus.put('B', new char[]
		{
				'E', 'S'
		});
		prevStatus.put('M', new char[]
		{
				'M', 'B'
		});
		prevStatus.put('S', new char[]
		{
				'S', 'E'
		});
		prevStatus.put('E', new char[]
		{
				'B', 'M'
		});
