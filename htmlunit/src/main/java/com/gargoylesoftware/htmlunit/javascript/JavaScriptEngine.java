    ...
    private abstract class HtmlUnitContextAction implements ContextAction {
        ...
        public final Object run(final Context cx) {
            ...
            try {
            	...
            	//e.printStackTrace();
            	//System.out.println("getWebClient().getOptions().isThrowExceptionOnScriptError(): " 
            	//		+ getWebClient().getOptions().isThrowExceptionOnScriptError());
                handleJavaScriptException(new ScriptException(page_, e, getSourceCode(cx)), 
                		getWebClient().getOptions().isThrowExceptionOnScriptError());
                return null;
            }
