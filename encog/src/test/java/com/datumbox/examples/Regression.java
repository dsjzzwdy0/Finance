...
public class Regression {
    ...
    public static void main(String[] args) {
        ...
        //Reading Data
        //------------Paths.get(
        // Clustering.class.getClassLoader().getResource("datasets/labor-statistics/longley.csv").toURI()).toFile()
        Dataframe trainingDataframe;
        try (Reader fileReader = new InputStreamReader(new FileInputStream(
        		new File("d:/index/datumbox/resources/datasets/labor-statistics/longley.csv")), "UTF-8")) {
        ...
        for(Map.Entry<Integer, Record> entry: testingDataframe.entries()) {
            ...
            System.out.println("Record " + rId + " " + r.toString());
        }
