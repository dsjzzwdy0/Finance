...
public class MatchDoc
{
	 ...
	 * @return
	 * 
	 * 		public IssueMatchDocs getMatchDataList(String lid) { IssueMatchDocs
	 *         list = new IssueMatchDocs(); for (MatchDoc match :
	 *         matchDatas.values()) { if(match.getLid().equals(lid)) {
	 *         list.addIssueMatchData(match); } } return list; }
	 * 
	 *         public CorpSetting getCorpSetting() { return corpSetting; }
	 * 
	 *         public void setCorpSetting(CorpSetting configure) { this.corpSetting
	 *         = configure; }
	 */
	...
	public MatchData getMatchData(String issue, String ordinary)
	{
		for (MatchData match : matchDatas.values())
		{
			if (issue.equals(match.getIssue()) && ordinary.equals(match.getOrdinary()))
			{
				return match;
			}
		}
