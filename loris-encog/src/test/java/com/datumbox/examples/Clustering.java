...
public class Clustering {
    ...
    public static void main(String[] args) {  
        ...
        //Reading Data Paths.get(Clustering.class.getClassLoader().getResource("datasets/heart-desease/heart.csv").toURI(
        //------------
        Dataframe trainingDataframe;
        try (Reader fileReader = new InputStreamReader(new FileInputStream(
        		new File("d:/index/datumbox/resources/datasets/heart-desease/heart.csv")), "UTF-8")) {
