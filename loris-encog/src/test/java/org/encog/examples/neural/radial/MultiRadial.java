...
public class MultiRadial {
    ...
    protected static double[][] convertColumnsTo2DSurface(double[][] cols, int valueCol)
    {
        //if (cols[0].Length != 3)
    ...
    protected static double[][] convert2DSurfaceToColumns(double[][] surface)
    {
    ...
    protected static void set1DTestingArrays(int sideLength)
    {
    ...
    protected static void set3DTestingArrays(int sideLength)
    {
        int iLimit = sideLength;
        int kLimit = sideLength;
